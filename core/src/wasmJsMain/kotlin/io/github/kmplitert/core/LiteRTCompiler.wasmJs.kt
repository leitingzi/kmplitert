...
import io.github.kmplitert.core.model.TensorDetails
import io.github.kmplitert.core.model.createCompileOptions
import io.github.kmplitert.core.model.createCpuOptions
import io.github.kmplitert.core.model.createLiteRtCompileOptions
import io.github.kmplitert.core.model.createLiteRtGpuOptions
import io.github.kmplitert.core.model.createLiteRtWebNNOptions
import io.github.kmplitert.core.model.getDefaultEnvironment
...
//        val compileOptions = getCompileOptions(accelerator = accelerator)
    ...
    actual suspend fun run(inputs: List<TFBuffer>, outputs: List<TFBuffer>, signatureIndex: Int) {
        val inputTensors = inputs.map {
            (it as WasmTFBuffer).tensor ?: throw IllegalStateException("Input buffer not initialized. Call write*() first.")
        }.toJsArray()
