...
object LiteRtUtils {
    ...
    fun createCompiledModel(environment: Pointer, model: Pointer, options: Pointer): Pointer {
    ...
    fun destroy(environment: Pointer, model: Pointer, options: Pointer, compiledModel: Pointer) {
